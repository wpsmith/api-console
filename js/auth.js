(function (e) {
    if ("function" == typeof bootstrap)bootstrap("wpapiauth", e); else if ("object" == typeof exports)module.exports = e(); else if ("function" == typeof define && define.amd)define(e); else if ("undefined" != typeof ses) {
        if (!ses.ok())return;
        ses.makeWpApiAuth = e
    } else"undefined" != typeof window ? window.wpApiAuth = e() : global.wpApiAuth = e()
})(function () {
